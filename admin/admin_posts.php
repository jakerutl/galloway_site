...
while($row = mysqli_fetch_array($posts)){
	echo "<h3>{$row['post_title']}</h3> <p>{$row['post_desc']}</p> <a href=\"//".$row['post_target']."\" target=\"_blank\">{$row['post_target']}</a> <br>	<a href=\"phpscripts/caller.php?caller_id=deletePost&id={$row['post_id']}\">Delete</a><br>";
}
?>
